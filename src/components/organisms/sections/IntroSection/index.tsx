...
const IntroSection = ({sectionData}: Props): JSX.Element => {
    let loaded = false
    const data = {
      features: [{
      	value: {
      ...
      body: {
        ...
        step2: {
          rawValue: "<p> </p><h1>ERFORDERLICHE UNTERLAGEN</h1><ul><li>Anschlussantrag rechtsgültig unterfertigt samt Abbuchungsauftrag</li><li>Baueingabeplan</li><li>Technikraumgrundriss</li></ul><p><b>Es ist in jedem Fall eine Besprechung vor Ort nötig.</b></p>"
        },
        step3: {
        ...
        <MDBContainer className="p-5">
          <MDBRow className="justify-content-center">
            <MDBCol md="9" className="text-center mb-3 col-features">
              <p dangerouslySetInnerHTML={{ __html: data.body.intro.rawValue }}></p>
            </MDBCol>
          </MDBRow>
          <MDBRow className="justify-content-center">
            {data.features.map((col, c) => {
              ...
              return (
                <MDBCol md="3" className="text-center mb-3 col-features" key={c}>
                  <img
                    src={col.value.feature_image}
