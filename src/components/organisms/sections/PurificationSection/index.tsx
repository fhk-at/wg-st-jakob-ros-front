...
const PurificationSection = ({sectionData}: Props): JSX.Element => {
    let loaded = false
    const data = {
      features: [{
      	value: {
    ...
    return (
      <div className="purification">
        <MDBRow className="justify-content-center">
          <MDBCol md="6" className="mb-3 col-purification">
            Purification
          </MDBCol>
          <MDBCol md="6" className="mb-3 col-purification">
            Purification
